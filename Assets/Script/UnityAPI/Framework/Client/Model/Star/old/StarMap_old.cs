...
namespace UnityAPI.Game {
    public class StarMap_old : MonoBehaviour {
        [System.Serializable]
        public class State {
        ...
        public static StarMap_old StaticInstance = null;

        public StarMap_old.GeneratorParameters StarMapGeneratorParameters = null;
        private StarGenerator.Parameters GeneratorParameterData = null;

        public StarMap_old.State StarMapState { get; private set; }
        public int StarMapInstanceID { get; set;}

        public StarMap_old.State InitialiseNewMapWithRandomParameters () {
        ...
        public StarMap_old.State InitialiseSavedMapWithLoadedParameters (StarMap_old.State state) {
            GeneratorParameterData = new StarGenerator.Parameters(
                StarMapGeneratorParameters.Prefabs.StarPrefab,
                StarMapGeneratorParameters.Prefabs.StarNodeContainerTransform,
                true,
